!function ($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            delimiterText: ', ',
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown"><span class="multiselect-selected-text mb-5"></span> <b class="caret"></b></button>',
