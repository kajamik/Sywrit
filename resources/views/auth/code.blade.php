...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">@lang('Inserisci il codice di sicurezza')</div>
                  ...
                  <p>Abbiamo inviato il codice all'indirizzo: <strong>{{ $email }}</strong> </p>
                    ...
                    <form method="POST" action="{{ route('sCode', ['email' => $email]) }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">@lang('Codice di sicurezza')</label>
