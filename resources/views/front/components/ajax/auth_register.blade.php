...
<form method="POST" action="{{ route('register') }}">
    ...
    <div class="form-group row">
        <label for="name" class="col-md-12 col-form-label text-center">{{ __('label.account.name') }}</label>
    ...
    <div class="form-group row">
        <label for="surname" class="col-md-12 col-form-label text-center">{{ __('label.account.surname') }}</label>
    ...
    <div class="form-group row">
        <label for="password" class="col-md-12 col-form-label text-center">{{ __('label.account.password') }}</label>
    ...
    <div class="form-group row">
        <label for="password-confirm" class="col-md-12 col-form-label text-center">{{ __('label.account.password_confirm') }}</label>
    ...
    <div class="form-group">
      <div class="col-md-12">
        <label>{!! __('label.terms_message') !!}</label>
      </div>
    </div>
