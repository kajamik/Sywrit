      ...
      <div class="container">
        <form method="post" action="{{ route('settings') }}" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <label for="name" class="col-md-4 col-form-label text-md-right required">{{ __('label.name') }}</label>
            <div class="col-md-6">
          ...
          <div class="form-group row">
            <label for="surname" class="col-md-4 col-form-label text-md-right required">{{ __('label.surname') }}</label>
            <div class="col-md-6">
          ...
          <hr/>
          <div class="form-group row">
            <label for="cover" class="col-md-4 col-form-label text-md-right">{{ __('label.cover_image') }}</label>
          ...
          <div class="form-group row">
            <label for="avatar" class="col-md-4 col-form-label text-md-right">{{ __('label.profile_image') }}</label>
          ...
          <div class="form-group row">
            <label for="bio" class="col-md-4 col-form-label text-md-right">{{ __('label.bio') }}</label>
        ...
        {{--
          ...
          <form method="post" action="{{ route('settings/username') }}">
            @csrf
            <div class="form-group row">
              <label for="username" class="col-md-4 col-form-label text-md-right required">{{ __('label.username') }}</label>
              <div class="col-md-6">
                <span>{{url('/')}}/</span>
            ...
            <div class="form-group row">
              <label for="verification" class="col-md-4 col-form-label text-md-right required">{{ __('label.password_confirm') }}</label>
            <div class="col-md-6">
          ...
          @csrf
            <div class="form-group row">
              <label for="old_password" class="col-md-4 col-form-label text-md-right">{{ __('label.old_password') }}</label>
              <div class="col-md-6">
            ...
            <div class="form-group row">
              <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('label.new_password') }}</label>
              <div class="col-md-6">
            ...
            <div class="form-group row">
              <label for="password_confirmation" class="col-md-4 col-form-label text-md-right">{{ __('label.password_confirm') }}</label>
              <div class="col-md-6">
          ...
          <form method="get" action="{{ url('account_delete') }}">
            ...
            <div class="form-group row">
              <div class="col-md-6 offset-md-5">
                <button class="btn btn-link" name="button">{{ __('label.del_account') }}</button>
              </div>
            </div>
            @endif
          </form>
